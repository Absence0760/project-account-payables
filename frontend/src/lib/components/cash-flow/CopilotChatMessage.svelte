...
<div class="msg" class:user={isUser} class:assistant={!isUser}>
	...
	<div class="msg-bubble">
		<!-- Tool results render before the prose so the cash-position chart /
		     tables appear as they stream in, ahead of the narrated answer. -->
		{#each message.tools as inv, i (i)}
			<CashFlowToolResult invocation={inv} />
		{/each}
